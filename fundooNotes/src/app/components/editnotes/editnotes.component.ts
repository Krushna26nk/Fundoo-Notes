...
export class EditnotesComponent implements OnInit {
  ...
  constructor(public dialogRef:MatDialogRef<EditnotesComponent>,@Inject(MAT_DIALOG_DATA) public data:any,
              private dialog:MatDialog,private urlService:UrlService,private refreshService:RefreshService) { }
...
this.dialog.closeAll();
    ...
    if(data != null){
      ...
      this.urlService.updateNote(data).subscribe(res => {
        console.log(res);
